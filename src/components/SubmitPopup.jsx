    ...
    return (
        <div className='fixed top-0 left-0 w-full h-screen bg-black/40 flex items-center justify-center z-50'>
            <div className='bg-white rounded-lg p-6 lg:w-1/3 w-full mx-8 lg:mx-0 flex flex-col items-center text-center'>
                <CiMail className='text-7xl text-(--primary-color) border-3 rounded-full p-2' />
                ...
                <div className='flex justify-center mt-6 gap-4'>
                    ...
                    }} className='bg-(--primary-color) w-38 text-white px-6 py-2 rounded-md hover:bg-(--secondory-color) transition duration-300'>
                        Call Now
                    </button>
                    <button onClick={() => { setShowpopup(false) }} className='bg-(--primary-color) w-38 text-white px-6 py-2 rounded-md hover:bg-(--secondory-color) transition duration-300'>
                        Back to Home
                    </button>
