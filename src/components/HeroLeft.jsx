...
const HeroLeft = () => {
  ...
  return (
    <div className='flex justify-center lg:justify-center items-start lg:items-center mt-16 lg:-mt-16 flex-col w-full lg:min-h-screen min-h-[70vh] pr-2 '>
        ...
        <p className=' lg:text-xl text-xl my-6 lg:w-[70%] lg:text-center capitalize text-white'>Gayatri Solar offers advanced solar energy solutions for residential, industrial, and rural projects. We focus on efficient, eco-friendly systems that reduce energy costs and promote a cleaner, sustainable future.</p>
