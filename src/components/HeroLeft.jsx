...
const HeroLeft = () => {
  ...
  return (
    <div className='flex justify-center lg:justify-center items-start lg:items-center mt-16 lg:-mt-16 flex-col w-full lg:min-h-screen min-h-[70vh] pr-2 '>
        <h3 className='text-(--primary-color) uppercase text-lg lg:text-2xl font-semibold'>welcome to Gayatri Solar</h3>
        <h2 className='text-3xl lg:text-7xl font-bold'>Lighting Lives with</h2>
        <h2 className='text-3xl lg:mt-2 lg:text-7xl text-nowrap font-bold text-(--primary-color)'>Smart Solar Solutions</h2>
        ...
        <div className='flex gap-6 lg:mt-3'>
            <Button1 className='shadow-white/20 shadow-lg' text="Our Services" onClick={() => handleScroll('Services')} />
            <Button1 className='shadow-white/20 shadow-lg' text="Contact Us" onClick={() => handleScroll('Contact')} />
        </div>
    </div>
